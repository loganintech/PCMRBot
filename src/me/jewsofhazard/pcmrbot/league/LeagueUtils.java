...
public class LeagueUtils {
    ...
    public static String getLevel(String region, String summonerName){  //this is broken, always catches
    try{
        return summoner.getName() + " is level " + summoner.getLevel();
        }
    catch(Exception e){
        System.out.println(e);
        //return "An error has occured checking for the level of the user, perhaps you used the wrong name or region?";
        return "";
        }
    }
}

...
public class IRCBot extends PircBot {
    ...
    /**
     * Ensures that the bot will automatically reconnect to the server if the
     * bot has been spontaneously disconnected. Hopefully
     */
    public void SaveChanList() {
     ...
     * @param sender - the sender of the message only used for the Hi Daddy
     * reply for me
     */
